...
const getGoods = async() =>{
  ...
  // parentId.value=goods.value.categories[1].id
}
onMounted(()=>{
  getGoods()
})
    ...
    <div class="container">
      <div class="bread-container" >
        <el-breadcrumb separator=">">
          ...
          <el-breadcrumb-item :to="{ path: '/' }">{{goods.categories?.[0].name}}
          </el-breadcrumb-item>
              ...
              <div class="goods-tabs">
                ...
                <div class="goods-detail">
                  ...
                  <!-- 图片 -->
                   ...
                   <li v-for="item in goods.details?.pictures" :key="item.id">

                      <img v-pic-lazy="item" alt="" />
